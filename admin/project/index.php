	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary new_project"
				...
				<tbody>
					...
					while ($row = $qry->fetch_assoc()):
						...
						<tr>
							...
							<td>
								<center><img src="<?php echo validate_image($row['banner']) ?>"
										class="banner-img img-thumbnail" alt=""></center>
							</td>
							...
							<td class="text-center">
								<div class="btn-group">
									<a href="javascript:void(0)" data-id='<?php echo $row['id'] ?>'
										class="btn btn-primary btn-flat btn-sm manage_project">
										<i class="fas fa-edit"></i>
									</a>
									<button type="button" class="btn btn-danger btn-sm btn-flat delete_project"
