		...
		<div class="card-body">
			<form id="project">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<textarea name="name" cols="30" rows="2"
								class="form-control"><?php echo isset($name) ? $name : '' ?></textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Location</label>
							<textarea name="client" cols="30" rows="2"
								class="form-control"><?php echo isset($client) ? $client : '' ?></textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea name="summary" id="" cols="30" rows="10"
								class="form-control"><?php echo (isset($summary)) ? html_entity_decode(($summary)) : '' ?></textarea>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea name="description" id="" cols="30" rows="10"
								class="form-control summernote"><?php echo (isset($description)) ? html_entity_decode(($description)) : '' ?></textarea>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label for="" class="control-label">Thumbnail Image</label>
				...
				<div class="form-group d-flex justify-content-center">
					<img src="<?php echo validate_image(isset($banner) ? $banner : '') ?>" alt="" id="cimg"
						class="img-fluid img-thumbnail">
				</div>
			</form>
		</div>
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="project">
