...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
				...
				<div class="row" class="details">
					...
					<div class="col-sm-6">
						<div class="form-group">
							...
							<textarea name="company" cols="30" rows="2"
								class="form-control"><?php echo isset($company) ? $company : '' ?></textarea>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
							<label for="" class="control-label">Position</label>
							<textarea name="position" cols="30" rows="2"
								class="form-control"><?php echo isset($position) ? $position : '' ?></textarea>
						</div>
					</div>
				</div>
				<div class="row">
		...
		<div class="card-footer">
			<button class="btn btn-primary btn-sm" form="work">
